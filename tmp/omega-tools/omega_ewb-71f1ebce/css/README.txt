...
To use these stylesheets, rename the files and omega_ewb with the name of your theme.
...
omega_ewb-alpha-default-narrow.css  
...
omega_ewb-alpha-default-normal.css
...
omega_ewb-alpha-default-wide.css
